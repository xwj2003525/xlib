...
namespace x {
    namespace time {
        ...
        public:
            static Stamp Now();
            static Stamp When(int year, int month=1, int day=1, int hour=0, int minute=0, int second=0, int millisecond=0);
        ...
        constexpr bool isValidDateTime(int year, int month, int day, int hour, int minute, int second, int millisecond);
    };
};
